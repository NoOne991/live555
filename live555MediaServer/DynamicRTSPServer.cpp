...
static ServerMediaSession* createNewSMS(UsageEnvironment& env,
  ...
  //if (strcmp(extension, ".m4e") == 0) {
    ...
    NEW_SMS("H.264 Video");
    OutPacketBuffer::maxSize = 512 * 1024; // allow for some possibly large MPEG-4 frames
    sms->addSubsession(RwH265VideoFileServerMediaSubsession::createNew(env, fileName, reuseSource));
  //}
